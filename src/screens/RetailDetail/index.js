        ...
        <ImageBackground source={bg} style={Style.backgroundImageLogin}>
          ...
          >
            ...
            <View style={{ backgroundColor: '#fff', marginBottom: 20 }}>
              ...
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>Pemilik</Text>
                  <Text note>{this.Capitalize(params.nama_pemilik)}</Text>
                </Body>
              </ListItem>
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>Email</Text>
                  <Text note>{params.email}</Text>
                </Body>
              </ListItem>
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>No. Handphone</Text>
              ...
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>Kecamatan</Text>
                  <Text note>{this.Capitalize(params.kecamatan)}</Text>
                </Body>
              </ListItem>
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>Kategori</Text>
                  <Text note>{this.Capitalize(params.lapak ? params.lapak.name : '-')}</Text>
                </Body>
              </ListItem>
              <ListItem style={{ marginLeft: 0 }}>
                <Body>
                  <Text style={{ color: '#00a357', fontSize: 14 }}>Website</Text>
