...
export function itemsHasErrored(bool: boolean) {
  return {
    type: "QUOTE_ITEMS_HAS_ERRORED",
    hasErroredQuote: bool
  };
}
export function itemsIsLoading(bool: boolean) {
  return {
    type: "QUOTE_ITEMS_IS_LOADING",
    isLoadingQuote: bool
  };
}
...
export function fetchData(page) {
  return dispatch => {
    return fetch(Root.link + 'quote/?page='+page, {
        method: 'GET',
        headers: {
